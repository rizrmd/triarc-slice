...
func _load_action_definitions():
	...
	action_defs = {
		...
		"flame-lance": {"name": "Flame Lance", "element": "fire", "cost": 3, "target": "enemy", "effect_kind": "damage_and_status", "base_power": 20, "status_kind": "dot", "status_duration_ms": 4000, "status_value": 6},
		"frostbolt": {"name": "Frostbolt", "element": "ice", "cost": 2, "target": "enemy", "effect_kind": "damage", "base_power": 15},
		"blizzard": {"name": "Blizzard", "element": "ice", "cost": 4, "target": "enemy"},
		"ice-nova": {"name": "Ice Nova", "element": "ice", "cost": 3, "target": "enemy", "effect_kind": "damage_and_status", "base_power": 18, "status_kind": "attack_buff", "status_duration_ms": 3000, "status_value": -12},
		"fortify": {"name": "Fortify", "element": "earth", "cost": 3, "target": "ally", "effect_kind": "shield", "base_power": 30},
		"shield-wall": {"name": "Shield Wall", "element": "earth", "cost": 3, "target": "ally"},
		"stand-firm": {"name": "Stand Firm", "element": "earth", "cost": 2, "target": "self", "effect_kind": "status", "status_kind": "shield", "status_duration_ms": 4000, "status_value": 15},
		"poison-strike": {"name": "Poison Strike", "element": "earth", "cost": 3, "target": "enemy", "effect_kind": "damage_and_status", "base_power": 16, "status_kind": "dot", "status_duration_ms": 6000, "status_value": 7},
		"toxic-coating": {"name": "Toxic Coating", "element": "earth", "cost": 2, "target": "ally", "effect_kind": "status", "status_kind": "attack_buff", "status_duration_ms": 5000, "status_value": 10},
		"chain-spark": {"name": "Chain Spark", "element": "wind", "cost": 3, "target": "enemy", "effect_kind": "damage", "base_power": 22},
		"smoke-bomb": {"name": "Smoke Bomb", "element": "wind", "cost": 3, "target": "enemy", "effect_kind": "status", "status_kind": "attack_buff", "status_duration_ms": 4000, "status_value": -15},
		"time-slip": {"name": "Time Slip", "element": "wind", "cost": 4, "target": "ally", "effect_kind": "status", "status_kind": "attack_buff", "status_duration_ms": 5000, "status_value": 18},
		"arcane-blast": {"name": "Arcane Blast", "element": "light", "cost": 4, "target": "enemy"},
		"holy": {"name": "Holy", "element": "light", "cost": 3, "target": "enemy", "effect_kind": "damage", "base_power": 24},
		"mana-weave": {"name": "Mana Weave", "element": "light", "cost": 2, "target": "ally", "effect_kind": "heal", "base_power": 20},
		"mirror-shield": {"name": "Mirror Shield", "element": "light", "cost": 4, "target": "ally", "effect_kind": "shield", "base_power": 45},
		"rally-cry": {"name": "Rally Cry", "element": "light", "cost": 3, "target": "ally", "effect_kind": "status", "status_kind": "attack_buff", "status_duration_ms": 5000, "status_value": 14},
		"cursed-dart": {"name": "Cursed Dart", "element": "shadow", "cost": 2, "target": "enemy", "effect_kind": "damage_and_status", "base_power": 12, "status_kind": "shield", "status_duration_ms": 4000, "status_value": -10},
		"leech-blade": {"name": "Leech Blade", "element": "shadow", "cost": 3, "target": "enemy", "effect_kind": "damage_and_status", "base_power": 20, "status_kind": "hot", "status_duration_ms": 4000, "status_value": 8},
		"shadowstep": {"name": "Shadowstep", "element": "shadow", "cost": 3, "target": "enemy", "effect_kind": "damage", "base_power": 26},
		"garrote": {"name": "Garrote", "element": "shadow", "cost": 3, "target": "enemy", "effect_kind": "damage_and_status", "base_power": 14, "status_kind": "dot", "status_duration_ms": 6000, "status_value": 8},
		"shiv": {"name": "Shiv", "element": "earth", "cost": 1, "target": "enemy", "effect_kind": "damage", "base_power": 10},
		"charge": {"name": "Charge", "element": "earth", "cost": 3, "target": "enemy", "effect_kind": "damage_and_status", "base_power": 22, "status_kind": "stun", "status_duration_ms": 1500, "status_value": 0},
		"cleave": {"name": "Cleave", "element": "earth", "cost": 3, "target": "enemy", "effect_kind": "damage", "base_power": 24},
		"execute": {"name": "Execute", "element": "earth", "cost": 4, "target": "enemy", "effect_kind": "damage", "base_power": 40},
		"riposte": {"name": "Riposte", "element": "earth", "cost": 2, "target": "self", "effect_kind": "status", "status_kind": "shield", "status_duration_ms": 3000, "status_value": 12},
		"intercept": {"name": "Intercept", "element": "earth", "cost": 3, "target": "ally", "effect_kind": "shield", "base_power": 25},
		"taunt": {"name": "Taunt", "element": "earth", "cost": 2, "target": "self", "effect_kind": "status", "status_kind": "shield", "status_duration_ms": 4000, "status_value": 18},
		"mark-target": {"name": "Mark Target", "element": "earth", "cost": 2, "target": "enemy", "effect_kind": "status", "status_kind": "shield", "status_duration_ms": 5000, "status_value": -12},
		"chain": {"name": "Chain", "element": "earth", "cost": 2, "target": "enemy", "effect_kind": "damage_and_status", "base_power": 14, "status_kind": "attack_buff", "status_duration_ms": 3000, "status_value": -8},
	}
